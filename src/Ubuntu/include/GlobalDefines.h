...
#define NN_KERNEL_IDX_FILL			13
#define NN_KERNEL_IDX_UPSAMPLE			14
#define NN_KERNEL_IDX_COPYGPU			15
#define NN_KERNEL_IDX_SHORTCUT			16
#define NN_KERNEL_IDX_ACTIVATE_KERNEL		17	
//-------------------------------------------------------------------------------- Debug by Hu Shiyu 2 -------------------------------------------------
