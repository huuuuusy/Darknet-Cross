...
OPENCV_BASEDIR:="/media/hu/hu-disk/test/opencv-test/opencv"
OPENCV_LOCAL_C_INCLUDES:="/media/hu/hu-disk/test/opencv-test/opencv/build" "/media/hu/hu-disk/test/opencv-test/opencv/include" "/media/hu/hu-disk/test/opencv-test/opencv/include/opencv"
OPENCV_MODULES:=dnn ml objdetect shape stitching superres videostab video calib3d features2d highgui videoio imgcodecs photo imgproc flann core
...
ifeq ($(OPENCV_LIB_TYPE),SHARED)
    OPENCV_LIBS:=dnn ml objdetect shape stitching superres videostab video calib3d features2d highgui videoio imgcodecs photo imgproc flann core
    OPENCV_LIB_TYPE:=SHARED
else
